...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <?=HTML::style('static/plugin/fbootstrapp/lib/bootstrap.less')?>
    <?=HTML::script('static/plugin/fbootstrapp/js/less-1.1.5.min.js')?>
...
<section id="media">
  <div class="page-header">
    <h1>Media <small>Example images</small></h1>
  </div>
